...
class MDPVehicle(ControlledVehicle):
    ...
    def __init__(self,
        ...
        if self.is_adv:
            ...
            self.neighbor_vehicles = 5
            self.observation_type = KinematicObservation(env, vehicles_count = self.neighbor_vehicles) 
            self.observation_type.observer_vehicle = self
